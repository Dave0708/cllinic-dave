...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="flex justify-between gap-4">
                        <a href="<?php echo e(route('users.index')); ?>" class="w-full text-center px-4 py-3 bg-gray-200 hover:bg-gray-300 text-gray-800 font-medium rounded-lg">
                            Cancel
                        </a>
...
</html><?php /**PATH C:\xampp\htdocs\CLINIC\resources\views/users/create.blade.php ENDPATH**/ ?>