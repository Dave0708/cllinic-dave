...
<head>
    ...
    <title>Edit User - Tejada Clinic</title>
    ...
    <div id="mainContent" class="ml-64 transition-all duration-300 p-8 mt-14">
        <div class="max-w-2xl mx-auto">
            <div class="bg-white rounded-lg shadow-md p-8">
                <h2 class="text-2xl font-bold text-gray-900 mb-8">Edit Account</h2>
                ...
                <form method="POST" action="<?php echo e(route('users.update', $user->user_id)); ?>">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="mb-6">
                        ...
                        <input type="text" 
                               class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent <?php $__errorArgs = ['username'];
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="mb-6">
                        ...
                        <input type="tel" 
                               class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent <?php $__errorArgs = ['contact'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="mb-6">
                        ...
                        <select class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent appearance-none <?php $__errorArgs = ['role'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                            ...
                            <?php $__currentLoopData = $roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($role->id); ?>" <?php echo e(old('role', $user->role) == $role->id ? 'selected' : ''); ?>>
                                    <?php echo e(ucfirst($role->role_name)); ?>
...
unset($__errorArgs, $__bag); ?>
                        <p class="text-gray-500 text-xs mt-1">Leave blank if you don't want to change the password</p>
                    </div>
                    ...
                    <div class="flex justify-between gap-4">
                        <a href="<?php echo e(route('users.index')); ?>" 
                           class="flex-1 text-center px-6 py-3 bg-gray-200 hover:bg-gray-300 text-gray-800 font-medium rounded-lg transition-colors">
                            Cancel
                        </a>
                        <button type="submit" 
...
</html><?php /**PATH C:\xampp\htdocs\CLINIC\resources\views/users/edit.blade.php ENDPATH**/ ?>