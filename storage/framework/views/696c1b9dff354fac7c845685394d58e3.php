    ...
    <main id="mainContent" class="min-h-screen bg-gray-100 p-6 lg:p-8 ml-64 mt-14 transition-all duration-300 peer-[.collapsed]:ml-16">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mt-6">
            ...
            <div class="grid grid-cols-2 sm:grid-cols-4 gap-4">
                ...
                <a href="<?php echo e(route('admin.db.backup')); ?>" class="bg-[#ccebff] text-gray-800 font-semibold p-4 rounded-lg flex flex-col items-center gap-2 hover:bg-blue-200 transition">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('index', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\CLINIC\resources\views/dashboard.blade.php ENDPATH**/ ?>