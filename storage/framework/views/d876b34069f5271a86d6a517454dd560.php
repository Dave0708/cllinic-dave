    ...
    <aside id="sidebar"
        ...
        <nav class="mt-10 w-full">
            <ul class="space-y-3 w-full">
                ...
                <li>
                    <a href="/appointment"
                        class="<?php echo e(request()->is('appointment*') ? 'active' : ''); ?>
                ...
                <li>
                    <a href="/patients"
                        class="<?php echo e(request()->is('patients*') ? 'active' : ''); ?>
                ...
                <li>
                    <a href="<?php echo e(route('users.index')); ?>"
                        class="<?php echo e(request()->is('users*') ? 'active' : ''); ?>
    ...
    <div id="mainContent" class="ml-64 transition-all duration-300 p-8 mt-14">
        <div class="max-w-7xl mx-auto">
            <div class="flex justify-between items-center mb-6">
                ...
                <a href="<?php echo e(route('users.create')); ?>" class="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg flex items-center gap-2">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-5">
                <?php $__empty_1 = true; $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="bg-white rounded-xl shadow-sm hover:shadow-md transition-shadow duration-200 border border-gray-100 relative">
                        ...
                        <?php if($user->roleInfo): ?>
                            <span class="absolute top-4 right-4 px-3 py-1 text-xs font-semibold rounded-full 
                                <?php echo e($user->roleInfo->role_name === 'admin' ? 'bg-red-100 text-red-700' : 
                                   ($user->roleInfo->role_name === 'staff' ? 'bg-blue-100 text-blue-700' : 
                                   'bg-gray-100 text-gray-700')); ?>">
                                <?php echo e(strtoupper($user->roleInfo->role_name)); ?>
                        ...
                        <div class="p-5">
                            <div class="flex items-center gap-4 mb-5">
                                <div class="flex-shrink-0 w-12 h-12 rounded-full flex items-center justify-center text-white text-xl font-bold
                                    <?php echo e($user->roleInfo && $user->roleInfo->role_name === 'admin' ? 'bg-red-500' : 
                                       ($user->roleInfo && $user->roleInfo->role_name === 'staff' ? 'bg-blue-500' : 
                                       'bg-purple-500')); ?>">
                                    <?php echo e(strtoupper(substr($user->username, 0, 1))); ?>

                                </div>
                                <h3 class="text-lg font-semibold text-gray-900 truncate"><?php echo e($user->username); ?></h3>
                            </div>
                            ...
                            <div class="space-y-3 mb-5">
                                ...
                                <div class="flex items-center gap-2 text-sm text-gray-600">
                                    ...
                                    <span><?php echo e($user->contact); ?></span>
                                </div>
                                <?php endif; ?>
                                ...
                                <div class="flex items-center gap-2 text-sm text-gray-600">
                                    ...
                                    <span>Joined: <?php echo e(\Carbon\Carbon::parse($user->created_at)->format('M d, Y')); ?></span>
                                </div>
                            </div>

                            <div class="border-t border-gray-100 pt-4 flex items-center justify-between gap-3">
                                <a href="<?php echo e(route('users.edit', $user->user_id)); ?>" 
                                ...
                                <?php if($user->user_id !== auth()->id()): ?>
                                    <form action="<?php echo e(route('users.destroy', $user->user_id)); ?>" 
                                          method="POST" 
                                          class="flex-1" 
                ...
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                    <div class="col-span-full text-center py-12">
                        ...
                        <p class="mt-1 text-base text-gray-500">Get started by adding a new user.</p>
                    </div>
                <?php endif; ?>
            </div>
            <div class="mt-6">
...
</html><?php /**PATH C:\xampp\htdocs\CLINIC\resources\views/users/index.blade.php ENDPATH**/ ?>