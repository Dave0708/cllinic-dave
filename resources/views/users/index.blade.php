...
<div class="container mx-auto">
    ...
    <div class="flex justify-between items-center mb-6">
        ...
        <a href="{{ route('users.create') }}" class="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg flex items-center gap-2 shadow-sm transition-colors">
                    ...
                    <div class="p-6">
                        <div class="flex items-center gap-4 mb-5">
                            ...
                            <div class="min-w-0">
                                ...
                                <p class="text-xs text-gray-500 truncate">ID: #{{ $user->user_id }}</p>
                            </div>
                        </div>
                        ...
                        <div class="border-t border-gray-100 pt-4 flex items-center gap-2">
                            ...
                            @if($user->user_id !== auth()->id())
                                <form action="{{ route('users.destroy', $user->user_id) }}" method="POST" class="flex-1" onsubmit="return confirm('Are you sure you want to delete this admin?');">
                                    @csrf
                                    @method('DELETE')
            ...
            @forelse($staffs as $user)
                <div class="bg-white rounded-xl shadow-sm hover:shadow-md transition-shadow duration-200 border border-gray-100 relative overflow-hidden">
                    ...
                    <div class="p-6">
                        ...
                        <div class="border-t border-gray-100 pt-4 flex items-center gap-2">
                            <a href="{{ route('users.edit', $user->user_id) }}" class="flex-1 py-2 text-sm font-medium text-center text-yellow-700 bg-yellow-50 hover:bg-yellow-100 rounded-lg transition-colors">Edit</a>
                            <form action="{{ route('users.destroy', $user->user_id) }}" method="POST" class="flex-1" onsubmit="return confirm('Are you sure you want to delete this staff member?');">
                                @csrf @method('DELETE')
