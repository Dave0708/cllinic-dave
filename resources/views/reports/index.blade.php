...
@section('content')
    <!-- 
        CUSTOM STYLES TO FIX SCROLLING & PRINTING 
        This forces your main layout header to stay on top and be solid white.
    -->
    <style>
        /* 1. Fix the Top Navigation Bar (Layout Header) */
        header {
            background-color: #ffffff !important; /* Force solid white */
            z-index: 999 !important;              /* Force it to be on top of everything */
            box-shadow: 0 1px 2px 0 rgba(0, 0, 0, 0.05); /* Restore subtle shadow */
        }

        /* 2. Fix Sidebar Z-Index */
        aside {
            z-index: 998 !important; /* Just below the header */
        }
        ...
        @media print {
            ...
            /* Reset margins so the report fills the paper */
            ...
            /* Backgrounds for charts */
            body { -webkit-print-color-adjust: exact; }
        }
    </style>

    <!-- Main Container -->
    <div class="p-6 sm:ml-64 mt-14 bg-slate-50 min-h-screen font-sans text-slate-800">
        ...
        <!-- Print Header (Only visible on PDF/Paper) -->
